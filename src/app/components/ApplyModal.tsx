...
interface Props {
  ...
  onSubmitData?: (data: ApplyFormData) => void;
}
...
export function ApplyModal({ onClose, signupData, onSubmitData }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const data: ApplyFormData = {
      ...
      extracurricularOther: form.extracurricularOther,
      selectedRoles,
      selectedSkills,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Submit a general application to South Point School Guwahati.
              We'll keep your information on file for suitable positions.
            </p>
          </div>
          ...
          {submitted ? (
            ...
            >
              ...
              >
                Thank you for applying to South Point School. We'll be in
                touch soon.
              </p>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} style={{ padding: "20px" }}>
              ...
              <div style={sectionStyle}>
                ...
                >
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <User size={13} style={{ color: MAROON }} />
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <Mail size={13} style={{ color: MAROON }} />
                        Email Address <span style={{ color: MAROON }}>*</span>
                      </span>
                    </label>
                    <input
                      style={{ ...inputStyle, background: "#f3f4f6", color: "#6b5c5c" }}
                      type="email"
                      value={form.email}
                      readOnly
                    />
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <Phone size={13} style={{ color: MAROON }} />
                        Phone Number <span style={{ color: MAROON }}>*</span>
                      </span>
                    </label>
                    <input
                      required
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <MapPin size={13} style={{ color: MAROON }} />
              ...
              <div style={sectionStyle}>
                ...
                >
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <GraduationCap size={13} style={{ color: MAROON }} />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => set("degreeName", e.target.value)}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        set("professionalQualification", e.target.value);
                      }}
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        set("professionalQualificationOther", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <Briefcase size={13} style={{ color: MAROON }} />
                  ...
                  <div className="sm:col-start-1">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        set("extracurricular", e.target.value);
                      }}
                    >
                      <option value="">Select qualification</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={form.extracurricularOther}
                      onChange={(e) =>
                        set("extracurricularOther", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div style={{ marginTop: "14px" }}>
                  <label style={labelStyle}>
                    Roles Interested In <span style={{ color: MAROON }}>*</span>
                  </label>
                  <SkillsMultiSelect
                    options={ALL_ROLES}
                ...
                <div style={{ marginTop: "14px" }}>
                  <label style={labelStyle}>
                    Skills & Strengths <span style={{ color: MAROON }}>*</span>
                  </label>
                  <SkillsMultiSelect
                    options={ALL_SKILLS}
                ...
                >
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <Linkedin size={13} style={{ color: MAROON }} />
                        LinkedIn Profile{" "}
                        <span style={{ fontWeight: 400, color: "#9a8a8a" }}>(Optional)</span>
                      </span>
                    </label>
                  ...
                  <div>
                    <label style={labelStyle}>
                      <span style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                        <LinkIcon size={13} style={{ color: MAROON }} />
              ...
              <div style={sectionStyle}>
                ...
                >
                  <Upload
                    size={28}
                    style={{ color: MAROON, margin: "0 auto 10px" }}
                  />
                  <div
                    style={{
                      color: "#1a0a0a",
