...
interface SignupData { name: string; lastName: string; email: string; phone: string; }
...
export function LoginModal({ onClose, initialTab = "login", onLoginSuccess, onSignupSuccess }: Props) {
  ...
  const handleVerifyOtp = (e: React.FormEvent) => {
    ...
    // Success: allow any 6-digit OTP to verify for demo convenience
    setForgotError("");
    setForgotStep(3);
  };
          ...
          <div style={{ padding: "24px" }}>
            {tab === "login" ? (
              <>
                ...
                <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <a
                      ...
                      style={{ color: MAROON, fontSize: "0.78rem", fontWeight: 600 }}
                    >
                      Forgot Password?
                    </a>
                  </div>
                ...
                <div style={{ textAlign: "center", marginTop: "14px", fontSize: "0.78rem", color: "#6b5c5c" }}>
                  ...
                  <form onSubmit={handleVerifyOtp} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input
                        ...
                        style={{ width: "100%", padding: "11px 12px 11px 36px", border: "1.5px solid rgba(0,0,0,0.15)", borderRadius: "8px", fontSize: "0.85rem", outline: "none", background: "#faf8f5", color: "#1a0a0a", boxSizing: "border-box", letterSpacing: "0.15em" }}
                        required
                      />
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "0.78rem" }}>
                      <span style={{ color: "#6b5c5c" }}>
                        {!canResendOtp ? `Resend OTP in ${otpTimer}s` : "Didn't receive OTP?"}
                      </span>
                      {canResendOtp && (
                  ...
                  <form onSubmit={handleResetPassword} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input
                        ...
                        style={{ width: "100%", padding: "11px 36px 11px 36px", border: `1.5px solid ${forgotConfirmPassword && forgotNewPassword !== forgotConfirmPassword ? "#d00" : "rgba(0,0,0,0.15)"}`, borderRadius: "8px", fontSize: "0.85rem", outline: "none", background: "#faf8f5", color: "#1a0a0a", boxSizing: "border-box" }}
                        required
                      />
