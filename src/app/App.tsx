...
import campusImg from "../imports/10a15b8b-d73e-4e1f-bec7-7aa8264d6092.jpg";
...
export default function App() {
  ...
  const [showJobApplicationModal, setShowJobApplicationModal] =
    useState(false);
  const [savedProfileData, setSavedProfileData] =
    useState<ApplyFormData | null>(null);
  const [cameFromApply, setCameFromApply] = useState(false);
  const [cameFromSection, setCameFromSection] = useState<"personal" | "professional" | "resume" | undefined>(undefined);
  const [applicationDraft, setApplicationDraft] = useState<any>(null);
  const [applicationsData, setApplicationsData] = useState<Record<number, {
    coverLetter: string;
    noticePeriod: string;
    hasReferral: string;
  ...
  const [loginTab, setLoginTab] = useState<"login" | "signup">(
    "login",
  );
  ...
  return (
    ...
    >
        ...
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                At South Point School, every role contributes to
                excellence in education and character building.
                Join a community that inspires, supports, and
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                {!loggedInUser && (
                  <button
                    onClick={() =>
                      document
                        .getElementById("apply-anyway")
                        ?.scrollIntoView({ behavior: "smooth" })
                    }
                    style={{
                      border: `1.5px solid rgba(250,248,245,0.45)`,
                      color: "#faf8f5",
                      fontWeight: 500,
                      fontSize: "0.875rem",
                      background: "transparent",
            ...
            <AnimatePresence mode="popLayout">
              {visibleJobs.length > 0 ? (
                visibleJobs.map((job, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Blur overlay on last card when more jobs are hidden */}
                      {!showAll &&
                        i === visibleJobs.length - 1 &&
                ...
                >
                  ...
                  >
                    No positions found matching your search. Try
                    a different keyword or category.
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
      ...
      <section
        id="apply-anyway"
        style={{
          background: `linear-gradient(135deg, ${CREAM} 0%, #f0e8d8 100%)`,
          display: loggedInUser ? "none" : undefined,
        }}
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              Submit your profile to our talent pool and be the first
              to hear when a role matching your expertise opens
              up at South Point School.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-5 mb-10">
              {[
                {
                  icon: Briefcase,
                  text: "All academic and administrative disciplines",
                },
                {
                  icon: Mail,
                  text: "Early notification for new openings",
                },
              ].map(({ icon: Icon, text }) => (
                <div
                  key={text}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map(({ icon: Icon, title, desc }, i) => (
              <motion.div
                ...
                style={{
                  border: `1.5px solid rgba(107,26,26,0.1)`,
                  background: CREAM,
                }}
              ...
              >
                <div
                  ...
                  className="p-3 mb-5 group-hover:bg-maroon transition-colors"
                >
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            >
              Help us improve your experience. We value every
              opinion.
            </p>
          </motion.div>
          ...
          {feedback.submitted ? (
            ...
            <motion.div
              ...
              style={{
                border: `1.5px solid rgba(107,26,26,0.12)`,
                borderRadius: "12px",
                background: "#fff",
                padding: "36px 32px",
            ...
            >
              <div className="grid sm:grid-cols-2 gap-5 mb-5">
                <div>
                  ...
                  <input
                    ...
                    style={{
                      border: `1.5px solid rgba(107,26,26,0.18)`,
                      borderRadius: "6px",
                      background: "#faf8f5",
                      color: "#1a0a0a",
                      fontSize: "0.875rem",
              ...
              <div className="mb-6">
                ...
                >
                  {feedback.message.length} character
                  {feedback.message.length !== 1 ? "s" : ""}
                </div>
              </div>
              <button
                onClick={() => {
      ...
      <footer
        style={{
          background: "#ffffff",
          borderTop: `1px solid rgba(107,26,26,0.12)`,
        }}
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          >
            ...
            />
            <span
              style={{ color: "#6b5c5c", fontSize: "0.8rem" }}
            >
          ...
          <div
            style={{ fontSize: "0.75rem", color: "#6b5c5c" }}
          >
            © 2026 South Point School. All rights reserved.
          </div>
        </div>
      </footer>
      {showLogin && (
